...
(* opens the message goes.  DeliverInitialMetadata looks like a third such *)
(* case and is not: it is unconditionally enabled precisely because the    *)
(* library can always answer it, from the wire or from the empty head it   *)
(* synthesizes for a call that ends without one.                           *)
(*                                                                         *)
