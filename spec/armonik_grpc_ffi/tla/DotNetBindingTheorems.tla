...
(* without proofs.  The proofs live in DotNetBindingTheorems_proofs, and   *)
(* every declaration here has one there, which is what registers the pair  *)
(* in ci/check.sh: that checker's contract is completeness.                *)
(***************************************************************************)
